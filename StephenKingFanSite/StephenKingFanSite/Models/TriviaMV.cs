...
namespace StephenKingFanSite.Models
{
    public class TriviaMV
    {
        ...
        {
            RightOrWrong1 = UserAnswer1 == "1947" ? "Right" : "Wrong";
            RightOrWrong2 = UserAnswer2 == "Carrie" ? "Right" : "Wrong";
            RightOrWrong3 = UserAnswer3 == "86" ? "Right" : "Wrong";
            RightOrWrong4 = UserAnswer4 == "200" ? "Right" : "Wrong";
            RightOrWrong5 = UserAnswer5 == "Richard Bachman" ? "Right" : "Wrong";
            RightOrWrong6 = UserAnswer6 == "34" ? "Right" : "Wrong";
            RightOrWrong7 = UserAnswer7 == "Maine" ? "Right" : "Wrong";
            RightOrWrong8 = UserAnswer8 == "True" ? "Right" : "Wrong";
            RightOrWrong9 = UserAnswer9 == "3" ? "Right" : "Wrong";
            RightOrWrong10 = UserAnswer10 == "Tabitha" ? "Right" : "Wrong";
            RightOrWrong11 = UserAnswer11 == "3" ? "Right" : "Wrong";
            RightOrWrong12 = UserAnswer12 == "300000000" ? "Right" : "Wrong";
            RightOrWrong13 = UserAnswer13 == "1971" ? "Right" : "Wrong";
            RightOrWrong14 = UserAnswer14 == "False" ? "Right" : "Wrong";
            RightOrWrong15 = UserAnswer15 == "823" ? "Right" : "Wrong";
            RightOrWrong16 = UserAnswer16 == "The Shining" ? "Right" : "Wrong";
            RightOrWrong17 = UserAnswer17 == "True" ? "Right" : "Wrong";
            RightOrWrong18 = UserAnswer18 == "1975" ? "Right" : "Wrong";
            RightOrWrong19 = UserAnswer19 == "True" ? "Right" : "Wrong";
            RightOrWrong20 = UserAnswer20 == "False" ? "Right" : "Wrong";
            RightOrWrong21 = UserAnswer21 == "False" ? "Right" : "Wrong";
            RightOrWrong22 = UserAnswer22 == "True" ? "Right" : "Wrong";
            RightOrWrong23 = UserAnswer23 == "Peter Straub" ? "Right" : "Wrong";
            RightOrWrong24 = UserAnswer24 == "True" ? "Right" : "Wrong";
            RightOrWrong25 = UserAnswer25 == "2015" ? "Right" : "Wrong";
            RightOrWrong26 = UserAnswer26 == "False" ? "Right" : "Wrong";
            RightOrWrong27 = UserAnswer27 == "False" ? "Right" : "Wrong";
            RightOrWrong28 = UserAnswer28 == "True" ? "Right" : "Wrong";
            RightOrWrong14 = UserAnswer29 == "True" ? "Right" : "Wrong";
            RightOrWrong20 = UserAnswer30 == "True" ? "Right" : "Wrong";
            RightOrWrong31 = UserAnswer31 == "True" ? "Right" : "Wrong";
            RightOrWrong32 = UserAnswer32 == "The Three Billy Goats Gruff" ? "Right" : "Wrong";
            RightOrWrong33 = UserAnswer33 == "True" ? "Right" : "Wrong";
            RightOrWrong34 = UserAnswer34 == "Red Sox" ? "Right" : "Wrong";
            RightOrWrong35 = UserAnswer35 == "2" ? "Right" : "Wrong";
            RightOrWrong36 = UserAnswer36 == "Time" ? "Right" : "Wrong";
            RightOrWrong37 = UserAnswer37 == "1983" ? "Right" : "Wrong";
            RightOrWrong38 = UserAnswer38 == "The Stanley Hotel" ? "Right" : "Wrong";
            RightOrWrong39 = UserAnswer39 == "The Overlook Hotel" ? "Right" : "Wrong";
            RightOrWrong40 = UserAnswer40 == "Mike Flanagan" ? "Right" : "Wrong";
            RightOrWrong41 = UserAnswer41 == "False" ? "Right" : "Wrong";
            RightOrWrong42 = UserAnswer42 == "False" ? "Right" : "Wrong";
            RightOrWrong43 = UserAnswer43 == "True" ? "Right" : "Wrong";
            RightOrWrong44 = UserAnswer44 == "8" ? "Right" : "Wrong";
            RightOrWrong45 = UserAnswer45 == "Michael Gornick" ? "Right" : "Wrong";
            RightOrWrong46 = UserAnswer46 == "1993" ? "Right" : "Wrong";
            RightOrWrong47 = UserAnswer47 == "Maine" ? "Right" : "Wrong";
            RightOrWrong48 = UserAnswer48 == "True" ? "Right" : "Wrong";
            RightOrWrong49 = UserAnswer49 == "3" ? "Right" : "Wrong";
            RightOrWrong50 = UserAnswer50 == "False" ? "Right" : "Wrong";
        }
    }
}
