...
namespace StephenKingFanSite.Controllers
{
    public class ScoresController : Controller
    {
        ...
        public ScoresController(KingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,HighScore,Ranking,Date")] Score score)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,HighScore,Ranking,Date")] Score score)
        {
            if (id != score.ID)
            {
                return NotFound();
