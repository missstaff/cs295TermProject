...
namespace StephenKingFanSite.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Director,PremiereDate,Genre")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Director,PremiereDate,Genre")] Movie movie)
        {
            if (id != movie.ID)
            {
                return NotFound();
